    ...
    <UL>
      <c:choose>
        <c:when test="${param.code == 'product_fail'}"> <%-- Java if --%>
          <LI class='li_none'>
            <span class="span_fail">공지사항 등록에 실패했습니다.</span>
          </LI>                                                                      
        </c:when>

        <c:when test="${param.code == 'create_success'}"> <%-- Java if --%>
          <LI class='li_none'>
            <span class="span_success">새로운 공지사항 등록했습니다.</span>
          </LI>  
          <LI class='li_none'>
            <button type='button' 
                         onclick="location.href='./create.do'"
                         class="btn btn-primary">새로운 공지사항 등록</button>
          </LI> 
        </c:when>
      ...
      <LI class='li_none'>
        ...
        <button type='button' onclick="location.href='./list_by_notice.do'" class="btn btn-primary">목록</button>
