...
<DIV class='content_body'>
  ...
  <TABLE class='table table-striped'>
    ...
    <c:forEach var="nbVO" items="${list}">
      ...
      <c:set var="nbgrpno" value="${nbVO.nbgrpno }" />
      <c:set var="name" value="${nbVO.name }" />
      <c:set var="rdate" value="${nbVO.rdate.substring(0, 10) }" />
...
function read_update_ajax(nbno) {
    ...
    $('#span_animation').html("<img src='/nbgrp/images/ani03.gif' style='width: 30px; height: 30px;'>");
...
function read_delete_ajax(nbno) {
  ...
  $('#span_animation_delete').html("<img src='/nbgrp/images/ani03.gif' style='width: 30px; height: 30px;'>");
