    ...
    <UL>
      <c:choose>
        ...
        <c:when test="${param.code == 'product_success'}"> <%-- Java if --%>
          ...
          <LI class='li_none'>                                                   
            <button type='button' 
                         onclick="location.href='./product_update.do?nbno=${param.nbno}&nbgrpno=${param.nbgrpno }&contentsno=${param.contentsno }'"
        ...
        <c:when test="${param.code == 'create_success'}"> <%-- Java if --%>
          ...
          <LI class='li_none'>
            ...
            <button type='button' 
                         onclick="location.href='./create.do?nbno=${param.nbno}&nbgrpno=${param.nbgrpno }'"
      ...
      <LI class='li_none'>
        ...
        <%-- <button type='button' onclick="location.href='./list_by_nbno.do?nbno=${param.nbno}'" class="btn btn-primary">목록</button> --%>
        <%-- <button type='button' onclick="location.href='./list_by_nbno_search.do?nbno=${param.nbno}'" class="btn btn-primary">목록</button> --%>
        <button type='button' onclick="location.href='./list_by_nbno_search_paging.do?nbno=${param.nbno}'" class="btn btn-info">목록</button>
