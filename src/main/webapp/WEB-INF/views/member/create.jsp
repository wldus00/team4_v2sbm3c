...
function pwcheck(){
    ...
    if(pw1 != "" || pw2 != ""){
        if(pw1 == pw2){
            ...
            $("#modal_pwcheck").attr('color','alert alert-success');
            } else {
                $("#modal_pwcheck").html('불일치');
                $("#modal_pwcheck").attr('color', 'red');
                $('#pw').val("");
                $('#pw2').val("");
            }
        }
  ...
  <!-- ******************** Modal 알림창 종료 ******************** -->
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        ...
        <button type='button' id="btn_checkID" class="btn btn-info btn-md" style="margin-top: 5px;">ID중복 체크</button>
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='username' id='username' 
                   value='' style='width: 30%;' placeholder="성명">
      </div>
    </div>
         <div class="form-group">
...
function DaumPostcode() {
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='address1' id='address1' 
                   value='' style='width: 30%;' placeholder="주소">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='address2' id='address2' 
                   value='' style='width: 30%;' placeholder="상세주소">
      </div>
    </div> 
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type="date" class="form-control" name='birth' id='birth' style='width: 30%;'>
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='tel' id='tel' 
                   value='' style='width: 30%;' placeholder="010-0000-0000">
      </div>
    </div> 
