    ...
    <form id='frm' name='frm' action='/recommend/recommend_nb/form2.do' method='GET'>
        ...
        <TABLE style='margin: 0px auto;'>
            <TR>
                ...
                <TD class='td_image'>
                    <img id='img2' src="/recommend_nb/images/v12.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/recommend_nb/images/v13.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img4' src="/recommend_nb/images/v14.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/recommend_nb/images/v15.jpg" style='float:left; height: 200px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
